...
- **From the member's profile** — Open **Dashboard → Members → [member]**. The **Moderation History** panel lists every case for that member, paginated 10 per page, with a breakdown of total warnings, timeouts, kicks, and bans at the top. Use this when you start from a specific person.
