...
Volvox.Bot takes your privacy seriously:

- Only data necessary for the bot to function is collected
- Data is shared only with service providers essential to running the platform (for example, Discord for authentication)
