...
export const CONFIG_CATEGORIES: ConfigCategoryMeta[] = [
  ...
  },
  {
    ...
    sectionKeys: ['welcome', 'reputation', 'xp', 'engagement', 'tldr'],
    featureIds: ['welcome', 'reputation', 'xp-level-actions', 'engagement', 'tldr'],
  },
  {
  ...
  },
  {
    ...
    sectionKeys: ['announce', 'snippet', 'poll', 'review', 'starboard'],
...
export const CONFIG_SEARCH_ITEMS: ConfigSearchItem[] = [
  ...
  },
  {
    ...
    description: 'Announce, snippet, poll, review.',
    keywords: ['announce', 'snippet', 'poll', 'review'],
    isAdvanced: false,
  },
  {
    id: 'tickets-core',
